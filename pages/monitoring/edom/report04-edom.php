...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">EDOM R.04 <small>Rekapitulasi Prodi Per Kelas&nbsp;</small></h1>
<!-- end page-header -->
<?php
	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				...
				<form action="monitoring/edom/edomreport4-pdf.php" name="isian" class="form-horizontal" method="POST">
