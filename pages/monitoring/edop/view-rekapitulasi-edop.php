...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">EDOP <small>Rekapitulasi&nbsp;</small></h1>
<!-- end page-header -->
<?php

include "../config/koneksi.php";
$tampilUsr = mysqli_query($Open, "select ta, utsuas, kodedosen, avg(spote_d) as rata2 from exoxpotensi$wheres where spote_d > 0 and ta='" . $pertax . "' group by kodedosen")
	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				...
				<form action="index.php?page=view-rekapitulasi-edop" name="isian" class="form-horizontal" method="POST">
