...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Data <small>Aspek - Parameter EDOM <i class="fa fa-angle-right"></i> Add&nbsp;</small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
    <div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form master data aspek - parameter EDOM</h4>
			</div>
			<div class="panel-body">
				<form action="index.php?page=master-data-edom" name="isian" class="form-horizontal" method="POST" enctype="multipart/form-data" >
