...
$hasil=mysql_query("select idprogstudi, nama, email from edopuser order by idprogstudi" ) or die("error:".mysql_error());
$nou=0;
$isi=0;
?>
	<span class="tablescroll">eDOP List User</span>
	<br/>
	...
	<thead>
		<tr>
		  ...
		  <td align=center>Nama Prodi</td>
		  <td align=center>NIP Ka Prodi</td>
		</tr>
	</thead>
	<tbody>
		<tr class="first">
