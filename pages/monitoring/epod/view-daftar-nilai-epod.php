...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">EPOD <small>Daftar Nilai&nbsp;</small></h1>
<!-- end page-header -->
<?php

include "../config/koneksi.php";
$tampilUsr = mysqli_query($Open, "select ta, utsuas, idprogstudi, kodedosen, kodemk, namadosen, namamk, komentar_p, spote_p from exoxpotensi$wheres where spote_p > 0 and ta = '" . $pertax . "' order by idprogstudi")
	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Results <span class="text-info"><?php echo mysqli_num_rows($tampilUsr); ?></span> rows for "Daftar Nilai"</h4>
			</div>

			<div class="panel-body">
				<!-- EOF Generate -->

				<form action="index.php?page=view-daftar-nilai-epod" name="isian" class="form-horizontal" method="POST">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td align=center style="width: 10px">
									<?php echo strtolower($usr['kodedosen']) ?></span>
								</td>
								...
								<td align=center style="width: 10px">
									<?php echo number_format($usr['spote_p'], 2, '.', ',') ?></span>
								</td>

								<td align=left>
									<?php echo $usr['komentar_p'] ?></span>
								</td>
