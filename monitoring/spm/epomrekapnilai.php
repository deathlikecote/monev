...
$hasil=mysql_query("select idprogstudi, avg(spote) as rata2 from epompotensi where spote > 0 group by idprogstudi" ) or die("error:".mysql_error());
$nou=0;
$isi=0;
?>
<span class="tablescroll">ePOM Rekap Nilai</span>
	<br/>
