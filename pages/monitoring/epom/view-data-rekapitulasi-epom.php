...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Data <small>Rekap Potensi EPOM&nbsp;</small></h1>
<!-- end page-header -->
<?php

include "../config/koneksi.php";
$hasil = mysqli_query($Open, "select * from epompotensi" . $wheres . " WHERE ta ='" . $pertax . "' group by kode order by idprogstudi,kelas_id");
	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Results <span class="text-info"><?php echo mysqli_num_rows($hasil); ?></span> rows for "Data Rekap Potensi EPOM"</h4>
			</div>

			<div class="panel-body">
				<!-- EOF Generate -->

				<form action="index.php?page=view-data-rekapitulasi-epom" name="isian" class="form-horizontal" method="POST">
				...
				<table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
					...
					<tbody>
						...
						while ($usr = mysqli_fetch_array($hasil)) {
							$hasil2 = mysqli_query($Open, "select * from epompotensi" . $wheres . " where kode='" . $usr['kode'] . "'");
							$row = mysqli_num_rows($hasil2);
							$hasil3 = mysqli_query($Open, "select * from epompotensi" . $wheres . " where kode='" . $usr['kode'] . "' and done=1");
							$row3 = mysqli_num_rows($hasil3);
							$hasil4 = mysqli_query($Open, "select * from epompotensi" . $wheres . " where kode='" . $usr['kode'] . "' and done=''");
