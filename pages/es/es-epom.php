...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Executive Summary <small>&nbsp;EPOM</small></h1>
<!-- end page-header -->
<?php
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
                <?php 
				 ...
				 ?>
				<form action="index.php?page=es-epom" name="isian" class="form-inline m-b-10" method="POST" >
                    ...
                    <div class="form-group">
		    				<a type="button" href="es/export-es-epom.php?perta=<?=$pertax?>" class="btn btn-success"><i class="fa fa-print"></i> Export</a>
                ...
                <div class="col">
                    Keterangan:<br>
                    A. Administrasi<br>
                    B. Kompetensi Profesional<br>
                    C. Sarana dan Prasarana<br>
                    D. Program (Teori & Praktek)<br><br>	
                </div>
                ...
                <table id="custom1" class="table table-striped table-bordered nowrap" >
                    ...
                    <?php
                        $a=0;
                        $No=1;
                        $sql=mysqli_query($plm_edom,'select * from epomdata_es '.$wheres.' group by namaprodi,total order by namaprodi,total asc');
