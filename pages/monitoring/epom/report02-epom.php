...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">EPOM R.02 <small>Prodi&nbsp;</small></h1>
<!-- end page-header -->
<?php
    ...
    <div class="col-md-12">
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				...
				<form action="monitoring/epom/epomreport2-pdf.php" name="isian" class="form-horizontal" method="GET" >
...
<script> // 500 = 0,5 s
	...
	function cariMK(){
		var perta = $('#perta').val();
		$.post("monitoring/epom/master-lookup.php", {jenis:'pilihKodexR2', perta:perta}, function(result){
			$('#kodex').html(result);
		});
	}
	...
	function cetakall(){
		...
		$("#kodex > option:not(:first)").each(function(i) {
			...
			var vals = this.value;
			setTimeout(function(){
		         window.location.href = 'monitoring/epom/epomreport2-pdf.php?kodex=' + vals +'&perta=' + perta;
		         no++;
