...
if (isset($_GET['id'])) {
	...
	$query   = mysqli_query($Open, "SELECT * FROM epodparameter WHERE id='$id'");
...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Data <small>Aspek - Parameter EPOD <i class="fa fa-angle-right"></i> Edit <i class="fa fa-key"></i> id_<?= $id ?></small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
	<div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form edit data aspek - parameter EPOD</h4>
			</div>
			<div class="panel-body">
				<form action="index.php?page=edit-data-epod&id=<?= $id ?>" name="isian" class="form-horizontal" method="POST" enctype="multipart/form-data">
