...
$qpot=mysqli_fetch_assoc(mysqli_query($Open, "select count(idprogstudi) as vpot from exoxpotensi$sta where idprogstudi='$xkode'"))  or die("error qpot:".mysqli_error());
$spotsis=$qpot['vpot'];
