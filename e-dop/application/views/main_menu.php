...
if(date('Y-m-d') < $this->session->userdata('tgl_awal')){
	...
	<div style="margin-top:50px; text-align:center;">
		<h2 style="color: green">Jadwal pengisian EDOP akan dibuka pada<br>'.$tglawal.'</h2>
	</div>
	';
	...
	echo '
	<div style="margin-top:50px; text-align:center;">
		<h2 style="color: green">Jadwal pengisian EDOP telah berakhir pada<br>'.$tglakhir.'</h2>
	</div>
	';
}else{
	?>
	<ul class="kotak" style="margin-top: -60px">
