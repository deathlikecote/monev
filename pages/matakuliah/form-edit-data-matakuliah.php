		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			...
			<div class="panel-body">
				<form action="index.php?page=edit-data-matakuliah&id=<?= $id ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="namamk" class="col-md-3 control-label">
					...
					<div class="form-group">
						<label for="skst" class="col-md-3 control-label">
							<font color="red">*&nbsp;</font>SKS Teori
						</label>
						<div class="col-md-1">
					...
					<div class="form-group">
						<label for="sksp" class="col-md-3 control-label">
							<font color="red">*&nbsp;</font>SKS Praktek
						</label>
						<div class="col-md-1">
