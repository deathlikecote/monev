...
<ol class="breadcrumb pull-right">
	<li>
		<?php
			...
			$cekRow	=mysqli_query($Open,"SELECT tglakhir FROM m_periode WHERE jenis = 'EPOM'");
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				<?php 
				 ...
				 ?>
				<form action="index.php?page=resume-epom" name="isian" class="form-horizontal" method="POST" >
		...
		if (isset($_POST['caridpmk'])){
		   ...
		   <hr style="margin-top:2px;">
			...
			<table style="width:100%;" id="custom1" class="table table-striped table-bordered nowrap" >
			  <tr>
			    <th width="42" rowspan="2" scope="col" style="text-align:center;vertical-align:middle">Prodi</th>
			    <th width="69" rowspan="2" scope="col" style="text-align:center;vertical-align:middle">Kelas</th>
			    <th colspan="4" scope="col" style="text-align:center;vertical-align:middle">Aspek</th>
...
echo'</table>
<a href="isiquesioner/epomreport2-pdf.php?kode='.$_SESSION['id_user'].'&perta='.$ta.'" target="_blank"><button class="btn btn-primary" style="width:100%;">Cetak PDF</button></a><br><br>
';
           ...
           AmCharts.makeChart("chartdiv",
				{
					...
					"dataProvider": [
						...
						{
							"category": "Program (Teori & Praktek)",
							"column-1": "'.$no['D'].'"
						}
					]
				}
