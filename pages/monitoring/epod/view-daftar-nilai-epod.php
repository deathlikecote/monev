...
<?php
	...
	$tampilUsr=mysqli_query($Open, "select ta, utsuas, idprogstudi, kodedosen, kodemk, namadosen, namamk, komentar_p, spote_p from exoxpotensi$wheres where spote_p > 0 order by idprogstudi") 
