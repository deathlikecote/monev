...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">EDOM R.05 <small>Rekapitulasi Dosen&nbsp;</small></h1>
<!-- end page-header -->
<?php
    ...
    <div class="col-md-12">
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				...
				<form action="monitoring/edom/edomreport5-pdf.php" name="isian" class="form-horizontal" method="POST" >
