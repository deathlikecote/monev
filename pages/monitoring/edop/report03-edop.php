...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">EDOP R.03 <small>Rekapitulasi Prodi&nbsp;</small></h1>
<!-- end page-header -->
<?php
    ...
    <div class="col-md-12">
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				...
				<form action="monitoring/edop/edopreport3-pdf.php" name="isian" class="form-horizontal" method="POST" >
