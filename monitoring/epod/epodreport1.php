...
<br>
<div class="row">
<form class="form-horizontal" method="post" action="epodreport1-pdf.php" >
    			...
    			<div class="col-sm-2">  
					<select name="kode" id="kode" class="form-control">
						<option value="" >Kode</option>
							...
							<?php
								$query = mysqli_query($plm_edom, "SELECT distinct(idprogstudi) FROM epoddata where idprogstudi <> '' order by idprogstudi") or die(mysqli_error());
