...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Referensi <small>Kelas Mahasiswa Aktif <i class="fa fa-angle-right"></i> Add&nbsp;</small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
    <div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form data kelas mahasiswa aktif</h4>
			</div>
			<div class="panel-body">
				<form action="index.php?page=master-data-kelas" name="isian" class="form-horizontal" method="POST" enctype="multipart/form-data" >
		    		...
		    		<div class="form-group">
		    			...
		    			<div class="col-md-2">
		    				<input type="text" class="form-control" name="kelas" id="kelas" placeholder="" value="">
		    			</div>
		    		</div>
	                        ...
	                        <option value="" disabled selected>--Pilih NIM--</option>
	                         <?php
	                            ...
	                            while($tak=mysqli_fetch_array($t)){
	                            	...
	                            	echo "<option value=".$tak['nim']."|".$tak['nama'].">".$tak['nim']." | ".$tak['nama']."</option>";  
	                          	}
	                          ?>
	                    </select>
