...
$tampilUsr = mysqli_query($Open, "select ta, utsuas, idprogstudi, avg(spote_p) as rata2 from exoxpotensi$wheres where spote_p > 0 and ta = '" . $pertax . "' group by idprogstudi")
