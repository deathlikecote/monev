...
->setTitle('Data Aspek Parameter EPOM'.$_SESSION['nama_pt'].' '.(date('Y')))
->setSubject('Data Aspek Parameter EPOM'.$_SESSION['nama_pt'].' '.(date('Y')))
->setDescription('Data Aspek Parameter EPOM')
->setKeywords('Data Aspek Parameter EPOM Export')
->setCategory('Data Export');

$spreadsheet->getActiveSheet()->mergeCells('A1:G1');
$spreadsheet->setActiveSheetIndex(0)->setCellValue('A1', (strtoupper($_SESSION['nama_pt'])));
$spreadsheet->setActiveSheetIndex(0)->setCellValue('A2', 'DATA ASPEK PARAMETER EPOM | '.(date('Y-m-d')));
...
$i=6; 
$no=1; 
$query = "SELECT * FROM epomparameter ORDER BY aspek, nourut ASC";
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Data-Aspek-Param-EPOM-'.date('Ymd'));
...
header('Content-Disposition: attachment;filename="Data-Aspek-Param-EPOM-'.date('Ymd').'.xlsx"');
