...
$this->Image('images/logocolor.jpg',10,9,15);
$this->SetFont('helvetica','B',9);
$this->Cell(16,5,'',0,0,'L');
$this->Cell(0,6,'POLTEKPAR PALEMBANG',0,1,'L');
...
//    $this->SetTextColor(128);
    // Page number
    $this->Cell(145,10,'@2013 - PPM POLTEKPAR PALEMBANG',0,0,'L');
    $this->Cell(25,10,'Page '.$this->PageNo().'/{nb}',0,0,'R');
}

function ChapterTitle($label1, $label2)
{
    // Arial 12
    //$this->SetLeftMargin(25);
    $this->SetFont('Arial','B',9);
    // Background color
//    $this->SetFillColor(109,202,236);
    $this->SetFillColor(200,220,255);
    $this->SetDrawColor(0,0,0);
    // Title
    $this->Cell(145,6,"$label1",0,0,'L',true);
    $this->Cell(25,6,"$label2",0,0,'C',true);
