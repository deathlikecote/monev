...
$xjnspar=2;
$qscpar=mysqli_query($plm_edom, "select a.idprogstudi, b.namaprodi, b.jurprodi, a.ta,a.per,a.utsuas,a.totscor,a.jmlpengajar from v_edop_overall_totalscore a, plm.m_prodi b where a.ta = '".$_SESSION['pertan']."' and b.kodeprodi=a.idprogstudi order by jurprodi asc");
...
$qv=mysqli_query($plm_edom, "select ta,per,utsuas from v_edop_overall_totalscore where idprogstudi='ADH'");
$sdata=mysqli_fetch_array($qv);
$sta=$_SESSION['pertan'];
$sper=$sdata['per'];
