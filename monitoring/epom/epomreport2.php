...
<br>
<div class="row">
<form class="form-horizontal" method="post" action="epomreport2-pdf.php" >
<div class="form-group">
    			...
    			<div class="col-sm-2">  
					<select name="kode" id="kode" class="form-control">
						...
						<?php
							$query = mysqli_query($plm_edom, "SELECT distinct(idprogstudi) FROM epomdata order by idprogstudi") or die(mysql_error());
