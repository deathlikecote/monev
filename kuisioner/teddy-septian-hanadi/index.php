			...
			<body>
				<div class="container mt-md-5 bg-light">
					<div class="col-12 py-5 px-3">
						<input type="hidden" name="projek" value="Teddy septian hanadi">
					<?php 
							
							$pageArr = array('');
							$rPageArr=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_page");
							...
							if($_SESSION['pageOld'] < $_SESSION['pageMe']){
								for($x = $_SESSION['pageMe']; $x < $arrlength; $x++) {
								  $numCek=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_page WHERE id_page='".$pageArr[$x]."'");
								  $rNum = mysqli_fetch_assoc($numCek);

								  $cekFilter=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_answer WHERE id_page_detail='".$rNum['variable']."' AND id_user='".$_SESSION['id_user_kuis']."'");
						...
						$rPage=mysqli_fetch_assoc(mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_page WHERE id_page='".$pageFilter."'"));

						$pageDetail=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_page_detail WHERE id_page='".$rPage['id_page']."' ORDER BY id_urut ASC");
					...
					<?php if($r['jenis'] == 'cv'){ ?>
					<?php 
					$qCekCv=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_answer WHERE id_page='".$rPage['id']."' AND id_page_detail='".$r['id']."' AND id_user='".$_SESSION['id_user_kuis']."'");
						$rCv = mysqli_fetch_assoc($qCekCv);

						$cekFilter=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_answer WHERE id_page_detail='".$r['variable']."' AND id_user='".$_SESSION['id_user_kuis']."'");
						$rf = mysqli_fetch_assoc($cekFilter);
					 ?>
					  ...
					  <div class="col-md-11 col-10" id = "<?=$rCv['id']?>">
					  	<?php 
				  			$filterCv=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_page_detail WHERE variable='".$r['id']."' ORDER BY id ASC");
					  	...
					  	<div class="mb-2"><?=$r['label']?></div>
					  		<?php 
					  			$qCv=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_cv WHERE id_page_detail='".$r['id']."' ORDER BY id ASC");
					...
					<?php if($r['jenis'] == 'tn'){ ?>
					  <?php 
						$qCekTn=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_answer WHERE id_page='".$rPage['id']."' AND id_page_detail='".$r['id']."' AND id_user='".$_SESSION['id_user_kuis']."'");
					...
					<?php if($r['jenis'] == 'tl'){ ?>
					<?php 
						$qCekTl=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_answer WHERE id_page='".$rPage['id']."' AND id_page_detail='".$r['id']."' AND id_user='".$_SESSION['id_user_kuis']."'");
...
<?php echo ($r['value'] == $rf['valuex'])?"":"collapse"; ?>" id="<?=$r['id']?>" >
					 ...
					 ?>
					  ...
					  <div class="col-md-11 col-10" >
					  	<div class="mb-2"><?=$r['label']?></div>
					  		...
					  		<?php 
					  			$qMd=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_md WHERE id_page_detail='".$r['id']."' ORDER BY id ASC");
								while($rowMd = mysqli_fetch_array($qMd)){
									$qCekMd=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_answer WHERE id_page='".$rPage['id']."' AND id_page_detail='".$r['id']."' AND id_jwb='".$rowMd['id']."' AND id_user='".$_SESSION['id_user_kuis']."'");
					  ...
					  <div class="col-md-11 col-10" id="<?=$rPage['id']?>">
					  	<div class="mb-2"><?=$r['label']?></div>
					  		...
					  		<?php 
					  			...
					  			$qRange=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_range WHERE id_page_detail='".$r['id']."' ORDER BY id ASC");
							 ...
							 <?php
					  			$qOr=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_or WHERE id_page_detail='".$r['id']."' ORDER BY id ASC");
								while($rowOr = mysqli_fetch_array($qOr)){

								$qCekOr=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_answer WHERE id_page='".$rPage['id']."' AND id_page_detail='".$r['id']."' AND id_jwb='".$rowOr['id']."' AND id_user='".$_SESSION['id_user_kuis']."'");
					...
					<div class="col-12 text-center my-5">
						<?php 
						/*$pageDetail=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_page WHERE id_page='".$rPage['id_page']."' ORDER BY id_urut ASC");
						while($r = mysqli_fetch_array($pageDetail)){

						}*/
							$qNm=mysqli_query($Open,"SELECT * FROM tb_teddy_septian_hanadi_page");
