...
$qjpar=mysqli_fetch_assoc(mysqli_query($plm_edom, "select count(id) as jmlpar from epomparameter$sta")) or die("error jmlpar:".mysqli_error());
$vjpar=$qjpar['jmlpar'];

//hitung jumlah siswa yang mengisi quesioner
$qjsis=mysqli_fetch_assoc(mysqli_query($plm_edom, "select count(id) as jmlsis from epomdata$sta where idprogstudi='$xkode'")) or die("error jmlsis:".mysqli_error());
...
mysqli_query($plm_edom, "update epomtemp01 t1 join (select idprogstudi, aspek, sum(v1) as jSC , count(id) as jSis from epomdata$sta group by idprogstudi, aspek) t2 
...
$qpot=mysqli_fetch_assoc(mysqli_query($plm_edom, "select count(nim) as vpot from epompotensi$sta where idprogstudi='$xkode'"))  or die("error as:".mysqli_error());
$spotsis=$qpot['vpot'];
...
$que1=mysqli_query($plm_edom, "select count(idprogstudi) as jmlisi from epompotensi$sta where idprogstudi='$xkode' and done=1")  or die("error as:".mysqli_error());
...
$quepot=mysqli_query($plm_edom, "select ta, per, utsuas, idprogstudi from epompotensi$sta where idprogstudi='$xkode'") or die(mysqli_error());
...
$pdf->SetLeftMargin(30);
$pdf->SetFont('Arial','',9);
$quekom=mysqli_query($plm_edom, "select kode, komentar from epompotensi$sta where idprogstudi='$xkode' and komentar <> ''")  or die("error as:".mysqli_error());
$nou=0;
...
//$filename="test1.pdf";
$filename="pdfoutput/epomr2-".$skodedsn."-".$perta.".pdf";
$filename2="epomr2-".$skodedsn."-".$perta.".pdf";
