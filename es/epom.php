...
<script type="text/javascript">
	function exportepom(){
    var perta = $('#perta').val();
    window.location = "exportepom.php?perta="+perta;
}
	...
	<div class="col-md-2">Kriteria<br>
		<select name="seldos" class="filterepom" style="width:100%;" onchange="filterepom()">
	...
	<a href="#" onclick="exportepom()">Export (.xls)</a>
	</div>
</div>
...
$a=0;
$No=1;
$sql=mysqli_query($plm_edom,'select * from epomdata_es where ta ="'.$perta.'" order by namaprodi,total asc');
