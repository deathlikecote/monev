...
$hasil=mysql_query("select idprogstudi, kelas, kodedosen, kodemk, namadosen, namamk, avg(spote) as rata2 from edompotensi where spote > 0 group by kodedosen, idprogstudi, kodemk, kelas" ) or die("error:".mysql_error());
$nou=0;
$isi=0;
?>
<span class="tablescroll">eDOM List Nilai</span>
	<br/>
