...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Data <small>Potensi EPOM&nbsp;</small></h1>
<!-- end page-header -->
<?php
	...
	<div class="col-md-12">
		...
		<div class="panel panel-inverse">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Results <span class="text-info"><?php echo mysqli_num_rows($tampilUsr); ?></span> rows for "Data Potensi EPOM"</h4>
			</div>

			<div class="panel-body">
				<!-- EOF Generate -->

				<form action="index.php?page=view-data-potensi-epom" name="isian" class="form-horizontal" method="POST">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td align=left>
									<?php echo strtoupper($usr['kelas_id']); ?>
								</td>
								...
								<td align=center>
									<?php echo strtoupper($usr['komentar']); ?>
								</td>
								<td align=center>
									<?php echo number_format($usr['spote'], 2); ?>
								</td>
