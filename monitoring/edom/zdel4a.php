...
// dari lain tabel
$qry=mysql_query("select kode, aspek, avg(scoreas) as vscoredos from edomtemp01 group by kode")  or die("error as:".mysql_error());
...
while ($gb=mysql_fetch_array($qry)) {
    ...
    $skode=$gb['kode'];
    $saspek=$gb['aspek'];
    $sscoreaspek=$gb['vscoredos'];
//    echo $sscoreaspek."<br>";
    mysql_query("update edomtemp01 set scoredos='$sscoreaspek' where kode='$skode'");    
//    if ($no == 1000) {
//       break;
//    }
}
