...
$tampilUsr = mysqli_query($Open, "select ta, utsuas, idprogstudi, kodedosen, kodemk, namadosen, namamk, komentar_d, spote_d from exoxpotensi$wheres  WHERE ta='" . $pertax . "' order by kodedosen")
