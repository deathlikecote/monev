...
define('PHPGRID_DB_HOSTNAME','174.120.70.240'); // database host name
define('PHPGRID_DB_USERNAME', 'dbreferensi');     // database user name
define('PHPGRID_DB_PASSWORD', 'wdbrefpass'); // database password
define('PHPGRID_DB_NAME', 'dbreferensi'); // database name
...
define('PHPGRID_DB_PASSWORD', 'chen41274'); // database password
define('PHPGRID_DB_NAME', 'sample'); // database name
define('PHPGRID_DB_TYPE', 'db2');  // database type
define('PHPGRID_DB_CHARSET','');
*/

define('SERVER_ROOT', '/sisakadmin/prog');
define('THEME', 'start');
