...
if (isset($_GET['id'])) {
	...
	$query   = mysqli_query($Open, "SELECT * FROM epomparameter WHERE id='$id'");
...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Data <small>Aspek - Parameter EPOM <i class="fa fa-angle-right"></i> Edit <i class="fa fa-key"></i> id_<?= $id ?></small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
	<!-- begin col-12 -->
	<div class="col-md-12">
		...
		<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
			<div class="panel-heading">
				...
				<h4 class="panel-title">Form edit data aspek - parameter EPOM</h4>
			</div>
			<div class="panel-body">
				<form action="index.php?page=edit-data-epom&id=<?= $id ?>" name="isian" class="form-horizontal" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<button type="submit" name="edit" value="edit" class="btn btn-primary" onclick="return validateForm()"><i class="fa fa-save"></i> &nbsp;Simpan</button>&nbsp;
							<a type="button" class="btn btn-default active" href="index.php?page=form-view-data-epom"><i class="ion-arrow-return-left"></i>&nbsp;Cancel</a>
						</div>
					</div>
				</form>
			</div>
