...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">EDOP R.04 <small>Dosen Prodi&nbsp;</small></h1>
<!-- end page-header -->
<?php
    ...
    <div class="col-md-12">
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				...
				<form action="monitoring/edop/edopreport4-pdf.php" name="isian" class="form-horizontal" method="GET" >
...
<script> // 500 = 0,5 s
	...
	function cetakall(){
		...
		$("#kodex > option:not(:first)").each(function(i) {
			...
			var vals = this.value;
			setTimeout(function(){
		         window.location.href = 'monitoring/edop/edopreport4-pdf.php?kodex=' + vals +'&perta=' + perta;
		         no++;
