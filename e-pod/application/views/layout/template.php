...
<input type="hidden" name="jmlpertanyaan" id="jmlpertanyaan" value="<?php echo $no-1;?>" />
	<ul class="kotak2" >
		<li class="xheader asbestos">
			<div class="judul">E P O D<small>Evaluasi Prodi Oleh Dosen</small>
			</div>
		</li>
		...
		<li class="petunjuk alizarin">
			...
			<h2>Petunjuk</h2>
			<p>
				Sesuai dengan yang Saudara ketahui, berilah penilaian secara jujur, objektif, dan penuh tanggung jawab terhadap Program Studi. Informasi yang Saudara berikan akan dipergunakan sebagai penilaian kinerja Program Studi dan sebagai salah satu masukan bagi perbaikan dan peningkatan kualitas proses belajar mengajar.</p>
			<p> 
				Penilaian dilakukan hanya mengklik pilihan YA atau TIDAK (score : 5 atau 0).
